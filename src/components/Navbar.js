...
const Navbar = () => {
  return (
    <div>
      ...
      <Menu right>
          <div className="menu-container bg-white h-full w-[100%]">
              <div className="text-2xl text-white font-bold pl-4 mt-3 pt-4 pb-4  bg-[#2e3147]">
                Hey!
              </div>
              <div>
                <p className= "mb-4 text-sm text-black ">Unlock special offer and great benifits</p>
                <Button className='bg-transparent border-b-2 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded'>Login / Register</Button>
              </div>
              <div>
                <p className="text-gray-700 mb-4 border-b-2">Some content for the menu</p>
              </div>
              <div>
                <p className="text-gray-700 mb-4 border-b-4">Some content for the menu</p>
              </div>
              <div>
                <p className="text-gray-700 mb-4 border-b-4">Some content for the menu</p>
              </div>  
        ...
        <div className="flex flex-col justify-center pl-4 text-md">
          <div className="search-container rounded-md bg-white px-3 py-1 flex items-center">
            <FontAwesomeIcon icon={faSearch} className="text-gray-700" />
            <input type="text" placeholder="Search for Movies, Events, Plays, Sports and Activities." className="ml-2 text-gray-700 focus:outline-none focus:shadow-outline-blue" style={{width:'500px'}}/>
          </div>
