    ...
    <>
      ...
      <div className="w-screen bg-[#333444]">
        <div className="flex justify-between py-3 w-[90%] ml-36">
            ...
            <>
              ...
              >
                <div className="text-center">
                  <input
                    placeholder="Search for Movies, Event, Plays, Sports and Activities"
                    className="bg-transparent outline-2 flex-1 w-[30%] px-4 py-2 rounded-xl"
                    type="text"
                  />
                </div>
                <div className="flex justify-around mt-7">
                  <div className="text-sm text-red-600 ">
                  <div className="font-bold mt-7"> TAMIL </div>
                    <div className="text-black mt-3 space-y-5">
                      <li className="flex flex-start">
                        Avatar the way of water ❤️
                      </li>
                      <li className="flex flex-start">Connect (UA) ❤️</li>
                      <li className="flex flex-start">Dear Death(U) ❤️</li>
                      <li className="flex flex-start">Driver Jamuna (UA) ❤️</li>
                      <li className="flex flex-start">Datta Kusthi (A) ❤️</li>
                      <li className="flex flex-start">Jasper (UA) ❤️</li>
                      <li className="flex flex-start">Laththi (A) ❤️</li>
                      <li className="flex flex-start">Love Today (UA) ❤️</li>
                      <li className="flex flex-start">Oh my Ghost (UA) ❤️</li>
                      <li className="flex flex-start">Raangi (UA) ❤️</li>
                      <li className="flex flex-start">
                        RajaavinParaville (UA) ❤️
                      </li>
                      <li className="flex flex-start">Sembi (A) ❤️</li>
                      <li className="flex flex-start">Driver Jamuna (UA) ❤️</li>
                    </div>
                  </div>
                  <div className="text-sm text-red-600 ">
                  <div className="font-bold mt-7"> ENGLISH </div>
                    <div className="text-black mt-3 space-y-5">
                      <li className="flex flex-start">
                        Avatar the way of water ❤️
                      </li>
                      ...
                      <li className="flex flex-start">Driver Jamuna (UA) ❤️</li>
                      <div className="text-sm text-red-600 ">
                      <div className="font-bold mt-10">TAMIL</div>
                    <div className="text-black mt-3 space-y-5">
                      <li className="flex flex-start">
                        Avatar the way of water ❤️
                      </li>
                  ...
                  <div className="text-sm text-red-600 ">
                  <div className="font-bold mt-7"> HINDI </div>
                    <div className="text-black mt-3 space-y-5">
                      <li className="flex flex-start">
                        Avatar the way of water ❤️
                      </li>
                  ...
                  <div className="text-sm text-red-600 ">
                  <div className="font-bold mt-7"> BENGALI </div>
                    <div className="text-black mt-3 space-y-5">
                      <li className="flex flex-start">
                        Avatar the way of water ❤️
                      </li>
          ...
          <div className="flex items-center text-gray-400 space-x-5 mr-36">
            <div
