      ...
      <div className="mt-32 ml-20 mr-20">
        ...
        <div className="flex justify-center space-x-10 mt-14">
          ...
          <div className="flex flex-col mt-20 ml-10 pl-10 w-[40%] ">
            <div className="text-gray-500 text-xl">
              Employee Enagagement Recognition & Rewards{" "}
            </div>
            <div className="text-3xl font-semibold mt-4">Brand Promotion</div>
            <div className="float-left mt-6 text-xl">
              Show your clients and employees some appreciation by gifting them
              our products
            </div>
          </div>
        </div>
        <div className="flex justify-center space-x-10 mt-14">
          <div className="flex flex-col mt-20 ml-10 pl-10 w-[40%] ">
            ...
            <div className="float-left mt-6 text-xl">
              Get positive referrals,keep existing customers and trigger change
              management
            </div>
          </div>
          <img
        ...
        <div className="flex justify-center space-x-10 mt-14">
          ...
          <div className="flex flex-col mt-20 ml-10 pl-10 w-[40%] ">
            ...
            <div className="float-left mt-6 text-xl">
              Keep customers firmly in your corner by rewarding them with our
              products
            </div>
          </div>
        </div>
        <div className="flex justify-center space-x-10 mt-14">
          <div className="flex flex-col mt-20 ml-10 pl-10 w-[40%] ">
            ...
            <div className="float-left mt-6 text-xl">
              From stand-up comedy and sporting activities to movies and plays,
              we've got all the entertainment worth gifting to your patrons.
            </div>
          </div>
          <img
