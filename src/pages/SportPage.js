...
import { imageLink1,imageLink2,imageLink3,imageLink4,imageLink5,imageLink6 } from "../Links/SportsLinks";
        ...
        <div className="flex flex-col flex-auto mr-10 pr-10 ">
          <div className="text-2xl font-bold">Sports in Chennai</div>
            <div className="list-none flex space-x-3 mt-4">
              <li><button className=" rounded-xl w-20 h-7 text-red-500 text-xs border-2 border-red-500 hover:text-white hover:bg-red-400">Online Games</button></li>
              <li><button className=" rounded-xl w-auto h-7 text-red-500 text-xs p-1 border-2 border-red-500 hover:text-white hover:bg-red-400">E Sports</button></li>
              <li><button className=" rounded-xl w-auto h-7 text-red-500 text-xs p-1 border-2 border-red-500 hover:text-white hover:bg-red-400">Football</button></li>
              <li><button className=" rounded-xl w-auto h-7 text-red-500 text-xs p-1 border-2 border-red-500 hover:text-white hover:bg-red-400">Chess</button></li>
